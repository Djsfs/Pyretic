...
class split_gateway(vdef): #check the other split_gateway.py example under ~/pyretic/pyretic/vdef folder first!
    ...
    def set_network(self,network):
        ...
        try:
            ...
            #......................
            self.derived.topology.add_link(Location(1002,1),Location(1001,2)) #internal s1001[1] -- s1000[4]

            self.derived.topology.add_link(Location(1003,1),Location(1002,2)) #internal s1002[2] -- s1003[1]

            self.derived.topology.add_link(Location(1004,1),Location(1003,2)) #internal s1003[2] -- s1004[1]
